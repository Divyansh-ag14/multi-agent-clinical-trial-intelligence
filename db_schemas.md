...
* **Location** : Google Cloud, `us-central1`, running 24/7
...
**Why we need it:**
This is the output of the entire system. Everything system does: ingestion, processing, memory, agents ultimately produces rows in this table. The FastAPI `/signals` endpoint reads from here. The human reviewer reads from here. This is where intelligence lives.
...
| `chunks`           | Text + 1536-number embedding per chunk | Processing pipeline | Every search tool  |
