...
#
# PURPOSE:
#   Single source of truth for all configuration in the codebase.
...
class Settings(BaseSettings):
    """
    All configuration defined in one place only.
    ...
    model_config = SettingsConfigDict(
        ...
        # always run from the src/ root directory.
    ...
    openai_chat_model: str = Field(
        default="gpt-4o",
        # GPT-4o is the reasoning model for signal detection.
    ...
    gcs_bucket_name: str = Field(
        ...
        # Example: "project-data-bucket-001"
    ...
    db_host: str = Field(
        ...
        #   Example: "/cloudsql/test001:us-central1:project-db"
    ...
    def database_url(self) -> str:
        ...
        Returns:
            ...
            Example: postgresql+asyncpg://test_user:password@35.232.74.203:5432/clinical_trial_db
        """
        return (
